...
# papeis = read.csv(file="papeis_da_ibovespa_2008_a_2014_com_IBOVESPA.csv") #mudanca dos setores, pois mudou a faixa temporal, está entre 2008 e 2014
# papeis = read.csv(file="papeis_da_ibovespa_2008_a_2014_com_97_5_IBOVESPA.csv") #mudanca dos setores, pois mudou a faixa temporal, está entre 2008 e 2014, importancia numa base de dados maior
papeis = read.csv(file="papeis_da_ibovespa_2008_a_2014_com_95_IBOVESPA.csv") #mudanca dos setores, pois mudou a faixa temporal, está entre 2008 e 2014, importancia numa base de dados maior
