...
dados_com_bovespa = read.csv(file="papeis_da_ibovespa_2008_a_2014_com_95_IBOVESPA.csv")
...
#     
    ...
    cor_beta[risco_beta$risco_beta_classificacao =="conservador"] = "green"
    cor_beta[risco_beta$risco_beta_classificacao == "moderado"] = "black"
    cor_beta[risco_beta$risco_beta_classificacao == "arrojado"] = "red"
