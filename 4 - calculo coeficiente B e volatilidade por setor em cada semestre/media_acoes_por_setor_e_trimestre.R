...
retorna_cluster = function(semestre){
  dados = subset(com_b_menor_que_2,com_b_menor_que_2$semestres_por_setores==semestre)
  k=2
  iter = 45
  dados = dados[,c(3,5)]
...
semestre = "2014.1"
cluster_2014_1 = cbind(data.frame(cluster = retorna_cluster(semestre)),com_b_menor_que_2[com_b_menor_que_2$semestres_por_setores==semestre,c("colunas","coeficiente_B","volatilidade","semestres_por_setores" )])
